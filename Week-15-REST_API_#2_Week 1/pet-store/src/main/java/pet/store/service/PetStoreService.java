...
public class PetStoreService {
	...
	public List<PetStoreData> retrieveAllPetStores() {
		...
		for (PetStore petStore : petStores) {
			PetStoreData tempPetStoreData = new PetStoreData(petStore);
			tempPetStoreData.getCustomers().clear();
			tempPetStoreData.getEmployees().clear();
			petStoreData.add(tempPetStoreData);
		}
